...
const ipCrossoverBrief = `Tên launch: Sự Kiện Hợp Tác IP Chiến Binh Ánh Sáng Sắp Chạy.
Phân loại: Sự kiện game / Hợp tác IP (Crossover)
Trạng thái: Sắp chạy
Owner chính: Brand Partnership PM + Legal Owner
Team liên quan: Product Marketing, Legal, Art/Asset, CS, Data/BI, Backend

Mục tiêu:
- Ra mắt sự kiện hợp tác IP giới hạn thời gian để kéo người chơi cũ quay lại.
- Tăng nhận diện thương hiệu và doanh thu bundle skin/vật phẩm crossover.
- Đo lượng người chơi tham gia chuỗi nhiệm vụ crossover.

Cơ chế:
- Chuỗi nhiệm vụ crossover 10 ngày, mở khóa skin và vật phẩm giới hạn của IP đối tác.
- Bán 2 bundle crossover, mỗi tài khoản mua tối đa 1 lần/bundle.
- Vật phẩm crossover chỉ phát trong thời gian sự kiện, không bán lại sau khi kết thúc.

Còn thiếu:
- Hợp đồng và điều khoản bản quyền với đối tác IP chưa ký bản cuối.
- Một số asset (skin, banner, hiệu ứng) chờ đối tác duyệt lần cuối, chưa khóa trong config.
- Cap số lượng vật phẩm crossover hiếm và giới hạn khu vực phát hành chưa chốt.
- CS FAQ cho case hiểu nhầm quyền sở hữu vật phẩm sau sự kiện chưa hoàn tất.
- Rule gỡ nội dung nếu đối tác yêu cầu dừng chưa được thống nhất với Legal.`;
const arenaCupBrief = `Tên launch: Giải Đấu Arena Cup Mùa Hè Sắp Chạy.
Phân loại: Sự kiện game / Giải đấu Esports
Trạng thái: Sắp chạy
Owner chính: Esports PM + Tech Lead
Team liên quan: Esports Ops, Gameplay, Backend/Infra, Anti-cheat, CS, Data/BI

Mục tiêu:
- Tổ chức giải đấu PvP theo mùa để tăng người chơi active và giờ chơi khung tối.
- Tăng số trận xếp hạng và lượt xem livestream trận chung kết.
- Thử hệ thống bảng đấu và trao thưởng tự động trước mùa giải chính thức.

Cơ chế:
- Vòng loại mở theo bảng đấu, top mỗi bảng vào vòng trong.
- Trận đấu theo khung giờ cố định 20:00-22:00; leaderboard cập nhật mỗi 2 phút.
- Prize pool và phần thưởng theo thứ hạng, trao tự động sau khi kết thúc giải.

Guardrail:
- Bảng đấu, prize pool, rule tie-break và thể thức đã được khóa và Business duyệt.
- Anti-cheat bật realtime; rule xử lý tài khoản gian lận và hủy kết quả đã được chốt.
- Backend/Infra đã test tải cho khung giờ cao điểm; có phương án scale và hàng đợi trận.
- Dashboard realtime có số trận, CCU, match error, report gian lận và trạng thái trao thưởng.
- Kill switch có thể tạm dừng vòng đấu; rollback trao thưởng đã test staging.
- CS FAQ đã cover khiếu nại kết quả trận, mất kết nối giữa trận, tie-break và nhận thưởng chậm.

Kế hoạch sau launch:
- Post-mortem T+48h tổng kết số trận, CCU, report gian lận, sự cố trận đấu và bài học cho mùa giải chính thức.`;

const SAMPLE_DATA_VERSION = "20260702-schedule-refresh";
