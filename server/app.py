...
UI_CACHE_VERSION = "fix-20260702f"
...
SAMPLE_DATA_VERSION = "20260702-schedule-refresh"
...
- Tổng kết wishlist theo segment và cập nhật brief cho đợt mở bán thật."""
    ip_crossover = """Tên launch: Sự Kiện Hợp Tác IP Chiến Binh Ánh Sáng Sắp Chạy.
...
- Rule gỡ nội dung nếu đối tác yêu cầu dừng chưa được thống nhất với Legal."""
    arena_cup = """Tên launch: Giải Đấu Arena Cup Mùa Hè Sắp Chạy.
